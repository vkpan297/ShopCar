      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">Hãng xe <span class="caret"></span></a>
          <ul class="dropdown-menu">
            ...
            <li><a href="ni.php" class="btn btn-primary disabled">Hãng Nissan</a></li>
...
<section id="a" class="billboard">
  ...
  <table >
   ...
   <tr>
     ...
     <td><img src="image/logonis.jpg" style="width: 50px; height: 50px; background-color: grey;"  /><a href="ni.php" class="btn btn-primary disabled" id="audi">Nissan</a></td>
   </tr>
...
$b1="select count(*) as tongcot from sanpham where mahang = 10";
...
$b = "select * from sanpham where mahang = 10 LIMIT $dongbatdau, $kichthuoctrang";
...
for($i=1; $i<=$tongsotrang; $i++){
    if($tranghientai==$i){
        ...
        ?>
 <button><a href="ni.php?tranghientai=<?php echo $i; ?>"><?php echo $i; ?></a></button>
<?php
}
}
?>
