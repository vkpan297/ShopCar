      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">Hãng xe <span class="caret"></span></a>
          <ul class="dropdown-menu">
            ...
            <li><a href="honda.php" class="btn btn-primary disabled">Hãng Honda</a> </li>
...
<section id="a" class="billboard">
  ...
  <table >
    ...
    <tbody>
     ...
     <td><img src="image/logotoyota.jpg" style="width: 50px; height: 50px; background-color: grey;"  /><a href="toyota.php" id="audi">Toyota</a></td>
   </tr>
   <tr>
     <td><img src="image/logohonda.jpg" style="width: 50px; height: 50px; background-color: grey;"  /><a href="honda.php" class="btn btn-primary disabled" id="audi">Honda</a></td>
...
$b1="select count(*) as tongcot from sanpham where mahang = 5";
...
$b = "select * from sanpham where mahang = 5 LIMIT $dongbatdau, $kichthuoctrang";
...
for($i=1; $i<=$tongsotrang; $i++){
    if($tranghientai==$i){
        ...
        ?>
 <button><a href="honda.php?tranghientai=<?php echo $i; ?>"><?php echo $i; ?></a></button>
<?php
}
}
?>
