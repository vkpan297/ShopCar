      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">Hãng xe <span class="caret"></span></a>
          <ul class="dropdown-menu">
            ...
            <li><a href="szk.php" class="btn btn-primary disabled">Hãng Suzuki</a></li>
...
<section id="a" class="billboard">
  ...
  <table >
   ...
   <tr>
     ...
     <td><img src="image/logosuzuki.jpg" style="width: 50px; height: 50px; background-color: grey;"  /><a href="szk.php" class="btn btn-primary disabled" id="audi">Suzuki</a></td>
...
$b1="select count(*) as tongcot from sanpham where mahang = 9";
...
$b = "select * from sanpham where mahang = 9 LIMIT $dongbatdau, $kichthuoctrang";
...
for($i=1; $i<=$tongsotrang; $i++){
    if($tranghientai==$i){
        ...
        ?>
 <button><a href="szk.php?tranghientai=<?php echo $i; ?>"><?php echo $i; ?></a></button>
<?php
}
}
?>
