      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">Hãng xe <span class="caret"></span></a>
          <ul class="dropdown-menu">
            ...
            <li><a href="me.php" class="btn btn-primary disabled">Hãng Mercedes</a></li>
...
<section id="a" class="billboard">
  ...
  <table >
   ...
   <tr>
     <td><img src="image/logomed.jpg" style="width: 50px; height: 50px; background-color: grey;"  /><a href="me.php" class="btn btn-primary disabled" id="audi">Mercedes</a></td>
...
$b1="select count(*) as tongcot from sanpham where mahang = 3";
...
$b = "select * from sanpham where mahang = 3 LIMIT $dongbatdau, $kichthuoctrang";
...
for($i=1; $i<=$tongsotrang; $i++){
    if($tranghientai==$i){
        ...
        ?>
 <button><a href="me.php?tranghientai=<?php echo $i; ?>"><?php echo $i; ?></a></button>
<?php
}
}
?>
