      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">Hãng xe <span class="caret"></span></a>
          <ul class="dropdown-menu">
            ...
            <li><a href="vk.php" class="btn btn-primary disabled">Hãng Volkswagen</a></li>
  ...
  <table >
   ...
   <tr>
     <td><img src="image/logomit.jpg" style="width: 50px; height: 50px; background-color: grey;"  /><a href="mi.php" id="audi">Mitsubishi</a></td>
      <td><img src="image/logovol.jpg" style="width: 50px; height: 50px; background-color: grey;"  /><a href="vk.php" class="btn btn-primary disabled" id="audi">Volkswagen</a></td>
   </tr>
...
$b1="select count(*) as tongcot from sanpham where mahang = 8";
...
$b = "select * from sanpham where mahang = 8 LIMIT $dongbatdau, $kichthuoctrang";
...
for($i=1; $i<=$tongsotrang; $i++){
    if($tranghientai==$i){
        ...
        ?>
 <button><a href="vk.php?tranghientai=<?php echo $i; ?>"><?php echo $i; ?></a></button>
<?php
}
}
?>
