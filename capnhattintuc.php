...
<script>
	function checkform(){
		document.forms['form1'].action='codecapnhattintuc.php';
...
<div id='all'>
<div id='form'>
<form class="login-form" name="form1" action="codecapnhattintuc.php" method="post">
<table border="0" cellspacing="10" align="center">
	...
	<tr>
		<th>Tiêu đề:</th>
		<td><input type="text" name="td" size="30" value="<?php echo $rs['tieude']; ?>" />
