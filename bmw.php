      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">Hãng xe <span class="caret"></span></a>
          <ul class="dropdown-menu">
            ...
            <li><a href="bmw.php" class="btn btn-primary disabled">Hãng BMW</a> </li>
...
<section id="a" class="billboard">
  ...
  <table >
   ...
   <tr>
     ...
     <td><img src="image/logobmw.jpg" style="width: 50px; height: 50px; background-color: grey;"  /><a href="bmw.php" class="btn btn-primary disabled" id="audi">Bmw</a></td>
   </tr>
...
$b1="select count(*) as tongcot from sanpham where mahang = 2";
...
$b = "select * from sanpham where mahang = 2 LIMIT $dongbatdau, $kichthuoctrang";
...
for($i=1; $i<=$tongsotrang; $i++){
    if($tranghientai==$i){
        ...
        ?>
 <button><a href="bmw.php?tranghientai=<?php echo $i; ?>"><?php echo $i; ?></a></button>
<?php
}
}
?>
