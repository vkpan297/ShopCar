      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">Hãng xe <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="audi.php" class="btn btn-primary disabled">Hãng Audi</a></li>
...
<div id="ads">
  <table >
    ...
    <tbody>
      <tr>
     <td><img src="https://icdn.dantri.com.vn/thumb_w/640/2018/10/17/largethumbnail-15397397525021234571470.jpg" style="width: 50px; height: 50px; background-color: grey;"  /><a href="audi.php" class="btn btn-primary disabled" id="audi">Audi</a></td>
...
$b1="select count(*) as tongcot from sanpham where mahang = 1";
...
$b = "select * from sanpham where mahang = 1 LIMIT $dongbatdau, $kichthuoctrang";
...
for($i=1; $i<=$tongsotrang; $i++){
    if($tranghientai==$i){
        ...
        ?>
 <button><a href="audi.php?tranghientai=<?php echo $i; ?>"><?php echo $i; ?></a></button>
<?php
}
}
?>
