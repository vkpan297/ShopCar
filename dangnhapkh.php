...
<li class="dropdown" id="ad"><a class="dropdown-toggle" data-toggle="dropdown" href="#"> <span class="glyphicon glyphicon-user"></span> <span class="hidden-xs">
<?php 
...
?>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="lichsu.php" class="btn btn-default btn-flat">Lịch sử</a>
                </div>
                <div class="pull-right">
                  <a href="dangxuatkh.php" class="btn btn-default btn-flat">Đăng xuất</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <form action="timkiem.php" method="get" class="navbar-form navbar-right" id="ac" role="search">
...
?>
  ...
  <p><h2><b>XE ĐANG ĐƯỢC RAO BÁN</b></h2></p>   
    <div class="row">
                <?php
$a=mysqli_connect('localhost','root','','otoonline1');
$b="select * from xecu order by ngaydang DESC limit 0, 9";
$c=mysqli_query($a, $b);
    ?>
    <?php
while ($row=mysqli_fetch_assoc($c)) {
